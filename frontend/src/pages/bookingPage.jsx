  ...
  const navList = (
    <ul className="mt-2 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
      <Typography as="li" variant="small" color="blue-gray" className="p-1 font-normal">
        <a href="#services" className="flex items-center">Services</a>
      </Typography>
      <Typography as="li" variant="small" color="blue-gray" className="p-1 font-normal">
        <a href="#projects" className="flex items-center">Projects</a>
      </Typography>
      <Typography as="li" variant="small" color="blue-gray" className="p-1 font-normal">
        <a href="#about-us" className="flex items-center">About Us</a>
      </Typography>
      <Typography as="li" variant="small" color="blue-gray" className="p-1 font-normal">
        <a href="#contact-us" className="flex items-center">Contact Us</a>
      </Typography>
    </ul>
  );
    ...
    <div className="-m-6 max-h-[768px] w-[calc(100%+48px)] overflow-scroll">
        ...
        <div className="flex items-center justify-between text-blue-gray-900">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-x-1">
              <a href="/logout">
                <Button variant="text" size="sm" className="hidden lg:inline-block text-black">
                  <span>Log out</span>
                </Button>
              </a>
            </div>
      ...
      <div className="mx-auto max-w-screen-md py-12">
        <Typography variant="h2" color="blue-gray" className="mb-8 text-center">
          Let’s Book Your Lockery
        </Typography>

        <div className="grid grid-cols-2 gap-4 mb-8">
          <div className="h-32 bg-gray-200 flex flex-col items-center justify-center p-4">
            <Typography variant="small" color="blue-gray" className="mb-2">HOT</Typography>
            <input
              type="checkbox"
              id="checkbox-hot"
              className="mb-2"
              checked={selectedLocker === "hot"}
              disabled={!!selectedLocker}
              onChange={() => handleCheckboxChange("hot")}
            />
          </div>
          <div className="h-32 bg-gray-200 flex flex-col items-center justify-center p-4">
            <Typography variant="small" color="blue-gray" className="mb-2">COLD</Typography>
            <input
              type="checkbox"
              id="checkbox-cold"
              className="mb-2"
              checked={selectedLocker === "cold"}
              disabled={!!selectedLocker}
              onChange={() => handleCheckboxChange("cold")}
            />
          </div>
        </div>
        <Typography color="gray" className="font-normal">Contact More Here:</Typography>
      </div>
    </div>
  );
}
